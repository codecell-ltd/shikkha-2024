...
@section('main')
    ...
    <main>
        <style>
            ...
            footer.footer__area.grey-bg-3.pt-270.p-relative {
                display: none;
            }
        </style>

        <!-- sign up area start -->
        <section class="signup_area po-rel-z1 pt-10 pb-145 bg_otp">
                ...
                <div class="row">
                    <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2">
                        <div class="text-center">
                            <img src="{{ asset('frontend/assets/img/logo/logo.webp') }}" alt="" width="120"
                                height="80">
                ...
                <div class="row mt-25">
                    <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                        <div class="sign__wrapper white-bg">
                            <h1 class="text-center fw-bold">Central Login</h1>
                                    ...
                                    @else
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            ...
                                            <div class="sign__input">
                                                <input type="text" placeholder="{{ __('app.signpopup2') }}"
                                                    name="email" value="{{ isset($email) ? $email : old('email') }}">
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            ...
                                            <div class="password-container">
                                                <div class="sign__input">
                                                    <input type="password" placeholder="{{ __('app.sign5') }}"
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-4">
                                                        <p class="radioOption-Item">
                                                            <input type="radio" name="BannerTypes" id="BannerType1"
                                                                value="student"
                                                                class="ng-valid ng-dirty ng-touched ng-empty"
                                                                aria-invalid="false">
                                                            <label for="BannerType1">
                                                                <img src="{{ asset('frontend/assets/img/logo/st.png') }}"
                                                                    alt="logo"><br>
                                                                {{ __('app.Student') }}
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="col-4">
                                                        <p class="radioOption-Item">
                                                            <input type="radio" name="BannerTypes" id="BannerType2"
                                                                value="teacher"
                                                                class="ng-valid ng-dirty ng-touched ng-empty"
                                                                aria-invalid="false">
                                                            <label for="BannerType2">
                                                                <img src="{{ asset('frontend/assets/img/logo/t.png') }}"
                                                                    alt="logo"><br>
                                                                {{ __('app.Teacher') }}
                                                            </label>
                                                        </p>
                                                    ...
                                                    <div class="col-4">
                                                        <p class="radioOption-Item">
                                                            <input type="radio" name="BannerTypes" id="BannerType3"
                                                                value="school" class="ng-valid ng-dirty ng-touched ng-empty"
                                                                aria-invalid="false">
                                                            <label for="BannerType3">
                                                                <img src="{{ asset('frontend/assets/img/logo/sc.png') }}"
                                                                    alt="logo"><br>
                                                                {{ __('app.School') }}
                                                            </label>
                                                        </p>
                                        ...
                                        <button class="w-btn w-btn-11 w-100 mt-5" type="submit">
                                            <span></span>{{ __('app.signin') }}</button>
