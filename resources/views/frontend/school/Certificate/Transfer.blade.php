...
<body>
    <div id="printDiv">
        <div class="certificate-container mt-3"
            style="background-image: url('{{ asset('Certificate/testimonial.png') }}')">
                ...
                <div class="certificate-body ">
                    ...
                    <div class="certificate-content">
                        ...
                        <div class="text-center">
                            <p class="topic-description ">During {{ $user->name }}'s time at
                                {{ $school->school_name }}
                                ...
                                {{ $user->name }} the very best in their future academic endeavors and personal
                                growth.
                            </p>
    ...
    <div class="col-12 d-flex justify-content-center mb-5 mt-3">
        <button class="btn btn-primary" style="background:#7c00a7; border:#7c00a7" title="{{ __('app.Print') }}"
            onclick="printDiv()"><i class="bi bi-printer"></i></button>
    </div>
